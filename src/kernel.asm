...
%DEFINE KNIGHTOS_VER '1.0.0'	; OS version number
%DEFINE KNIGHT_API_VER 18	; API version for programs to check
...
option_screen:
	...
	os_init_msg		db 'Welcome to KnightOS', 0
	os_version_msg		db 'Version ', KNIGHTOS_VER, 0

	dialog_string_1		db 'Thanks for trying out KnightOS!', 0
...
; FEATURES -- Code to pull into the kernel
	...
	%INCLUDE "library/cmd.asm"
 	%INCLUDE "library/disk.asm"
	%INCLUDE "library/keyboard.asm"
	%INCLUDE "library/math.asm"
	%INCLUDE "library/misc.asm"
	%INCLUDE "library/ports.asm"
	%INCLUDE "library/screen.asm"
